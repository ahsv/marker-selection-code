...
# NearestCentroidClassifier doesn't normalize correctly, but we compute and
...
########## ZEISEL 14
rawdata = np.load("/home/ahsvargo/publicData/zeisel/zeisel-proc.npz")
